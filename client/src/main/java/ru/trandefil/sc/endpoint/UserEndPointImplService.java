...
public class UserEndPointImplService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.sc.trandefil.ru/", "UserEndPointImplService");
    public final static QName UserEndPointImplPort = new QName("http://endpoint.sc.trandefil.ru/", "UserEndPointImplPort");
    static {
        URL url = null;
        try {
