 ...
 * 2019-03-14T18:44:29.666+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "TaskEndPointImplService",
                  wsdlLocation = "http://localhost:8080/JavaEE/TaskEndPointImpl?wsdl",
                  targetNamespace = "http://endpoint.sc.trandefil.ru/")
public class TaskEndPointImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.sc.trandefil.ru/", "TaskEndPointImplService");
    public final static QName TaskEndPointImplPort = new QName("http://endpoint.sc.trandefil.ru/", "TaskEndPointImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/JavaEE/TaskEndPointImpl?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(TaskEndPointImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/JavaEE/TaskEndPointImpl?wsdl");
        }
        WSDL_LOCATION = url;
    }
