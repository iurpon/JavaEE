 ...
 * 2019-03-13T17:17:07.248+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "ProjectEndPointImplService",
                  wsdlLocation = "http://localhost:8080/JavaEE/ProjectEndPointImpl?wsdl",
                  targetNamespace = "http://endpoint.sc.trandefil.ru/")
public class ProjectEndPointImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.sc.trandefil.ru/", "ProjectEndPointImplService");
    public final static QName ProjectEndPointImplPort = new QName("http://endpoint.sc.trandefil.ru/", "ProjectEndPointImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/JavaEE/ProjectEndPointImpl?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ProjectEndPointImplService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/JavaEE/ProjectEndPointImpl?wsdl");
        }
        WSDL_LOCATION = url;
    }
